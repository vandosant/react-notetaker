    ...
    return (
      <div>
        ...
        <ul className="list-group">
          ...
          <li className="list-group-item"><img className="img-thumbnail" src={this.props.bio.avatar_url}/></li>}
          ...
          {this.props.bio.blog &&
          <li className="list-group-item">Website: <a href={this.props.bio.blog}>{this.props.bio.blog}</a></li>}
        </ul>
      </div>
    )
  }
